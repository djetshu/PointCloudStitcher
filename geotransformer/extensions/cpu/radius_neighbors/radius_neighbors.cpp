...
at::Tensor radius_neighbors(
  ...
  std::vector<int64_t> vec_q_lengths = std::vector<int64_t>(
    reinterpret_cast<int64_t*>(q_lengths.data_ptr<int64_t>()),
    reinterpret_cast<int64_t*>(q_lengths.data_ptr<int64_t>()) + batch_size
  );
  ...
  std::vector<int64_t> vec_s_lengths = std::vector<int64_t>(
    reinterpret_cast<int64_t*>(s_lengths.data_ptr<int64_t>()),
    reinterpret_cast<int64_t*>(s_lengths.data_ptr<int64_t>()) + batch_size
  );
